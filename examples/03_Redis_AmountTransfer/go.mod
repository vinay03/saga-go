module github.com/vinay03/saga-go/examples/03_Redis_AmountTransfer

go 1.21.3

replace github.com/vinay03/saga-go => ../../
...
require (
	...
	github.com/vinay03/saga-go v0.0.0-20240418022944-1500563f4a75 // indirect
